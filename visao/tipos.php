...
$info_bd = busca_info_bd($conexao, 'tipo');
$title = "tipos";
...
<body> <!-- corpo da pagina -->
    ...
    <table class="tabela_export">
        ...
        <tbody>
            <?php
            foreach ($info_bd  as $tipo) {
            ?>
                <tr>
                    <td>

                        <?php echo $tipo['descriçaoTipo']; ?>
                    ...
                    <td width="200">
                        <div class="d-flex">
                            <div class="status mx-5" style="cursor: pointer">
                                ...
                                ?>
                                    <div onClick="alterar_status('N',<?= $tipo['idTipo'] ?>)" data-toggle="tooltip" title="Ativo">
                                ...
                                ?>
                                    <div onClick="alterar_status('S',<?= $tipo['idTipo'] ?>)" data-toggle="tooltip" title="Inativo">
                            ...
                            <div class="editar" data-reg="<?= $tipo['idTipo'] ?>" data-toggle="tooltip" title="Editar" style="cursor: pointer">
